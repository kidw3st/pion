...
// Лента с короткими версиями статей для Дзена.
require_once __DIR__ . '/inc/dzen-feed.php';
// Ссылки на отложенные статьи появляются в текстах сами, когда статья выходит.
require_once __DIR__ . '/inc/pending-links.php';
