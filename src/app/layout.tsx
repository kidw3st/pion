...
export const metadata: Metadata = {
  ...
  // Дзен подтверждает права своим тегом, отдельно от Вебмастера: нужен,
  // чтобы привязать канал к сайту и ставить в статьи ссылки на него.
  // Next не знает про zen-verification, поэтому он идёт через other —
  // ключ оттуда попадает в name как есть.
  verification: {
    yandex: '3af3a385502c11ad',
    other: {
      'zen-verification': 'z9Aee31490tWZS77j4fO5DTeCd8Q7WrO7bvWB3Ma6MlXBdO4xD6ZnPM1qffmomXO',
    },
  },
